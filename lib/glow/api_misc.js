    ...
    */
    ...
    function print_to_string(args) {
        ...
        for (var i=0; i<L; i++) {
            ...
            if (toType(arg) == "array") {
            	arg = parsearray(arg)
            } else if (window.__GSlang != 'javascript') { // vpython or rapydscript
    ...
    function pa(L) {
        ...
        for (var i=0; i<L.length; i++) {
            ...
            else if (a === null) s += (window.__GSlang != 'javascript') ? 'None ' : 'null '
    ...
    function parsearray(L) {
        ...
        if (L === null) return (window.__GSlang != 'javascript') ? 'None' : 'null'
